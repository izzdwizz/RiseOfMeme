...
const LandingSection = () => {
  return (
    <div className="flex landingWrapper card  flex-col text-white items-center justify-start relative w-full min-w-screen min-h-max h-full p-8 md:p-12">
      ...
      <div className="md:p-5 rounded-full md:border-[.8rem] md:h-max md:w-max text-center  border-white bg-[#10a3e895] text-3xl font-rubber fixed top-[5rem] right-[2rem] hover:bg-[#5bc4f5e8] duration-300 ease-in-out cursor-pointer md:rounded-[0%_100%_100%_100%] rotate-45 droplet ">
